...
if ($_POST) {
    ...
    $sentencia = $conexion->prepare("INSERT INTO atrasosrecep(motivo, fecha, hora, idestudiante) 
                                    VALUES (:motivo, :fecha , :hora, :idestudiante)");
...
<div class="card">
    ...
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="fecha" class="form-label">Fecha de atraso</label>
